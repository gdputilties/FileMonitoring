...
def get_file_name(src_path, wachdirectory):
    ...
    watch_file = src_path[len_watch_dir_path + 1:len_event_src_path]
    return watch_file


class MyHandler(FileSystemEventHandler):
    watchDirectory = InvestigateFile.get_value_from_properties("WatchDIR")
    ...
    def on_modified(self, event):
        ...
        fileStartsWith = InvestigateFile.get_value_from_properties("FileStartsWith")
    ...
    def on_created(self, event):
        ...
        '''if file_name.startsWith(fileStartsWith):
            if file_extension == ".log":
                ...
                print("CSV file")
                InvestigateFile.read_log_file(file_path)'''


event_handler = MyHandler()
observer = Observer()
path = InvestigateFile.get_value_from_properties("WatchDIR")
